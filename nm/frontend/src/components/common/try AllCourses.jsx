...
// Define a color array for unique colors
const colorArray = ["#FFB6C1", "#ADD8E6", "#98FB98", "#FFD700", "#FF6347", "#EE82EE"];
   ...
   return (
      <>
         ...
         <div className='p-2 course-container'>
            {allCourses?.length > 0 ? (
               allCourses
                  .filter(course => filterTitle === '' || course.C_title?.toLowerCase().includes(filterTitle?.toLowerCase()))
                  .filter(course => {
                     if (filterType === 'Free') {
                  ...
                  .map((course, index) => (
                     <div key={course._id} className='course' style={{ backgroundColor: colorArray[index % colorArray.length] }}>
                        <div className="card1">
                           <div className="desc">
                              <h3>Modules</h3>
                           ...
                           <div className="details">
                              <div className="center">
                                 ...
                                 {user.userLoggedIn === true ?
                                       ...
                                       <Modal show={showModal[index]} onHide={() => handleClose(index)}>
                                          ...
                                          <Modal.Body>
                                             ...
                                             <Form onSubmit={(e) => {
                                                ...
                                                <MDBInput className='mb-2' label="Card Holder Name" name='cardholdername' value={cardDetails.cardholdername} onChange={handleChange} type="text" size="md" placeholder="Cardholder's Name" required />
                                                <MDBInput className='mb-2' name='cardnumber' value={cardDetails.cardnumber} onChange={handleChange} label="Card Number" type="number" size="md" placeholder="1234 5678 9012 3457" required />
                                                <MDBRow className="mb-4">
                                                   ...
                                                   <MDBCol md="6">
                                                      <MDBInput name='cvvcode' value={cardDetails.cvvcode} onChange={handleChange} className="mb-2" label="Cvv" type="number" size="md" placeholder="&#9679;&#9679;&#9679;" required />
                                                   </MDBCol>
                                                </MDBRow>
                                                <div className="d-flex justify-content-end">
                                                   <Button className='mx-2' variant="secondary" onClick={() => handleClose(index)}>Close</Button>
                                    ...
                                    : <Link to={'/login'}><Button variant='outline-dark' size='sm'>Start Course</Button></Link>}
                              </div>
                           </div>
                        </div>
                     </div>
